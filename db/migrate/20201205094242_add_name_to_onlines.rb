class AddNameToOnlines < ActiveRecord::Migration[5.2]
  def change
    ...
    add_column :onlines, :math_iaf, :integer
    add_column :onlines, :math_ias, :integer
    add_column :onlines, :math_iibf, :integer
    add_column :onlines, :math_iibs, :integer
    add_column :onlines, :math_iiicf, :integer
    add_column :onlines, :math_iiics, :integer
